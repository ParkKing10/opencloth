 ...
 * Per-user, per-browser (same tradeoff as thumbnails / the AI library — Supabase sync is a future add).
 */
...
export async function putGarmentImage(key: string, dataUrl: string): Promise<void> {
  try {
...
/** Read a garment-edit image (data URL) by garment id, or null if none/unreadable. */
